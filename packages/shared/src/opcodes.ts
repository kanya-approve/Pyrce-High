...
export enum OpCode {
  ...
  C2S_SHOVE = 1918,
  C2S_PDA_SEND = 1919,
  C2S_CONTAINER_PUSH = 1920,
  C2S_CORPSE_PUSH = 1921,
  C2S_LIGHT_SWITCH_TOGGLE = 1922,
  C2S_CAMERA_VIEW = 1923,
  C2S_TAPE_VIEW = 1924,
  C2S_TAPE_DELETE = 1925,
  C2S_OFFER_EYES = 1926,
  C2S_ACCEPT_EYES = 1927,
  ...
  S2C_CONTAINER_MOVED = 2511,
  S2C_LIGHT_STATE = 2512,
  S2C_BLOOD_DRIP = 2513,
  S2C_CAMERA_FEED = 2514,
  S2C_TAPE_RESULT = 2515,
  S2C_EYE_OFFER = 2516,
